...
public class JenkinsService {
    ...
    public List<JenkinsResult> getAllLatestResults() {
        try {
            ...
            log.error("Error getting latest results: {}", e.getMessage());
    ...
    public JenkinsResult getLatestResultByJobName(String jobName) {
        try {
            ...
            log.error("Error getting result for job {}", jobName, e);
            return null;
        }
    }
    ...
    public List<JenkinsTestCase> getTestCasesByResultId(Long resultId) {
        try {
            ...
            log.error("Error getting test cases for result {}", resultId, e);
            return new ArrayList<>();
        }
    }
        ...
        try {
            ...
            for (String jobName : jobNames) {
                try {
                    ...
                    log.error("Failed to sync job {}", jobName, e);
                }
            }
        }
        catch (Exception e) {
